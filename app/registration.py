...
from app.keyboards import (checking_choise_markup, checking_cancel_markup,  # type: ignore
                           make_keyboard_accepting, make_profile_markup)
from database.database import new_user, get_user  # type: ignore
...
async def start(message: Message, state: FSMContext):
    ...
    if user:
        ...
        await message.answer(f'Приветик, {name}^^ У тебя {coins} монеток')
